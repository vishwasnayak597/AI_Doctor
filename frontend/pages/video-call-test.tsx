...
const VideoCallTestPage: React.FC = () => {
  ...
  const appointmentId = '68aae708fc4d8b90de6b35f7'; // Hardcoded for testing

  console.log('🚀 VIDEO CALL TEST PAGE LOADED - STATIC ROUTE');

  return (
    <>
      <Head>
        <title>Video Call Test - aiDoc</title>
      </Head>
            ...
            <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full mx-4">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-500 mb-6">
                  ...
                  <p><strong>Route Type:</strong> Static (Working)</p>
                </div>
            ...
            <div className="flex-1 bg-black flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-gray-300 mb-6">
                  ✅ Working video call interface (static route)
                </p>
                ...
                <div className="bg-gray-800 rounded-lg p-6 max-w-md mx-auto">
                  ...
                  <ul className="text-sm space-y-1 text-left">
                    ...
                    <li>• Static route works perfectly</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 p-6">
              ...
              <div className="text-center mt-4">
                <p className="text-sm text-gray-400">
                  ✅ Video call interface working on static route!
                </p>
              </div>
            </div>
          </div>
